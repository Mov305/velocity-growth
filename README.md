...
> Status: stage 5 (sending and provider feedback) built. Hosted Supabase project migrated, seeded and loaded with the full data; Google sign-in configured; app not yet deployed. Sections marked **decision** are settled.
